...
public class MAIN {
	...
	public static boolean ins_corso(CorsoLaurea[] corsi)
	{
		...
		{
			System.out.println("Non e' possibile aggiungere corsi si laurea!");
			return false;
		}
		boolean c = true;
	...
	public static boolean rimuovi_corso()
	{
		...
		if(!c)
		{
			System.out.println("Non e' possibile rimuovere corsi di laurea!");
			return false;
		}
		boolean r = true; 
		String nome;
	...
	// 		login (scorro vettore studenti finche' non combaciano credenziali)
	...
	boolean t = true;
		...
		do {
			...
			System.out.println("Qunati corsi puo' ospitare l'ateneo?");
			...
			System.out.println("M) apri menu' corso");
